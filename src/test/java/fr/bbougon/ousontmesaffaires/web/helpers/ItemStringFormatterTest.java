...
public class ItemStringFormatterTest {
    ...
    private static final String EXPECTED_FIRST_ITEM_FORMAT = "type;chaussure|folder_name|" +
    ...
    private static final String EXPECTED_SECOND_ITEM_FORMAT = "type;pantalon;couleur;marron|folder_name_2|" +
